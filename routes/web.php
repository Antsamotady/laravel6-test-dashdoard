...
Route::get('/dashboard/menu2/submenu1', 'DashboardController@menu2Submenu1')->name('dashboard.submenu1');
Route::get('/dashboard/menu2/submenu2', 'DashboardController@menu2Submenu2')->name('dashboard.submenu2');
